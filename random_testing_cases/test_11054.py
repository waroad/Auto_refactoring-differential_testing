...
original_script = "examples/backjoon/11054.py"
updated_script = "updated/backjoon/11054.py"

@settings(max_examples=100, deadline=None)
@given(N=st.integers(min_value=1, max_value=10),
       list1=st.lists(st.integers(min_value=-1000, max_value=1000), min_size=1, max_size=10))
