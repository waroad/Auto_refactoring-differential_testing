...
def test_foo1():
    assert ori_module.foo1(0, 1, None, None) == test_module.foo1(0, 1, None, None)
    assert ori_module.foo1(0, 0, None, None) == test_module.foo1(0, 0, None, None)
def test_foo2():
    assert ori_module.foo2(0, 1, None) == test_module.foo2(0, 1, None)
    assert ori_module.foo2(0, 0, None) == test_module.foo2(0, 0, None)
    assert ori_module.foo2(1, None, None) == test_module.foo2(1, None, None)
    assert ori_module.foo2(0, None, None) == test_module.foo2(0, None, None)
def test_foo3():
    assert ori_module.foo3(0, 1, None, None) == test_module.foo3(0, 1, None, None)
    assert ori_module.foo3(0, 0, None, None) == test_module.foo3(0, 0, None, None)
    assert ori_module.foo3(1, None, None, None) == test_module.foo3(1, None, None, None)
    assert ori_module.foo3(0, None, None, None) == test_module.foo3(0, None, None, None)
    assert ori_module.foo3(1, 0, None, None) == test_module.foo3(1, 0, None, None)
