...
def test_bar2():
    ...
    assert ori_module.bar2() == test_module.bar2()
def test_bar3():
    assert ori_module.bar3(0, 0, 0) == test_module.bar3(0, 0, 0)
    assert ori_module.bar3(0, 0, 0) == test_module.bar3(0, 0, 0)
    assert ori_module.bar3(0, 0, 0) == test_module.bar3(0, 0, 0)
def test_bar4():
...
def test_bar6():
    ...
    assert ori_module.bar6() == test_module.bar6()
def test_bar7():
    assert ori_module.bar7(0, 0, 0) == test_module.bar7(0, 0, 0)
    assert ori_module.bar7(0, 0, 0) == test_module.bar7(0, 0, 0)
    assert ori_module.bar7(0, 0, 0) == test_module.bar7(0, 0, 0)
    assert ori_module.bar7(1, 0, 0) == test_module.bar7(1, 0, 0)
    assert ori_module.bar7(0, 0, 0) == test_module.bar7(0, 0, 0)
    assert ori_module.bar7(-1, 0, 0) == test_module.bar7(-1, 0, 0)
    assert ori_module.bar7(0, 0, 0) == test_module.bar7(0, 0, 0)
    assert ori_module.bar7(0, 0, 0) == test_module.bar7(0, 0, 0)
